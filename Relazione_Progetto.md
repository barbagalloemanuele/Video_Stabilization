...
## Conclusioni
I risultati finali dimostrano chiaramente che non esiste un algoritmo perfetto in ogni situazione, ma c'è un compromesso tra la capacità di gestire gli ostacoli e la qualità visiva del video:

- **I punti di forza di Lucas-Kanade**: Questo metodo si rivela eccellente quando la scena è abbastanza sgombra e il movimento della videocamera, pur essendo mosso, rimane continuo e senza scatti improvvisi (come nei video riding1 e riding2). In queste situazioni, calcola gli spostamenti in modo molto preciso e applica correzioni leggere che mantengono alta la qualità dell'immagine (ottenendo i migliori punteggi di PSNR e SSIM). Va in crisi, però, quando i movimenti sono troppo bruschi: se tra un frame e l'altro c'è uno scossone forte, l'algoritmo perde il tracciamento dei pixel.
- **I vantaggi di ORB + RANSAC**: Questa combinazione, invece, domina nelle scene più caotiche o con molti elementi in movimento (come climbing1, climbing2, walking1 e driving1). RANSAC è eccezionale nell'ignorare gli ostacoli temporanei (come persone o veicoli di passaggio), concentrandosi solo sul vero sfondo per calcolare il movimento. Questo permette di appiattire in modo impressionante anche i tremolii più violenti, migliorando drasticamente lo *Stability Score*. Il compromesso è che, per compensare questi scossoni, le immagini vengono ruotate o spostate maggiormente, creando dei bordi neri più ampi che abbassano leggermente la fedeltà visiva complessiva.

In sintesi, la soluzione ideale per il futuro sarebbe un'architettura **Ibrida**: usare Lucas-Kanade come metodo di base per le scene più stabili e lineari, passando il controllo a ORB+RANSAC solo nel momento in cui la telecamera subisce urti troppo forti e l'Optical Flow non riesce più a seguire la scena.